...
<html>
    <head>
        <title>Calendario Signot Gestión Agotada</title>
        <meta name="description" content="Gestión Agotada, Signot V. 1.0 2017 Juan Esteban Múnera Betancur">
    ...
    <!--<body> -->
        <div class="container">
            <?php if ( in_array($_SESSION['idUsuario'],$usuariosa) ) { ?>
                <div class="hero-unit">
                    <h1>Gestión Agotada <i class="icon-calendar"></i></h1>
                    <p>SIGNOT</p>	
                </div>
                <div class="page-header">
                    ...
                    <h3></h3>
                    <small>Calendario Gestión Agotada</small>
                </div>
                <div class="row">
                    <div class="span11">
                        <div id="calendar"></div>
