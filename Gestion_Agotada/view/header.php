            ...
            <?php if ( in_array($_SESSION['idUsuario'],$usuariosa) ) { ?>
                <nav class="navbar navbar-default">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href=""><i class="icon-calendar"></i> Gestión Agotada</a>
                    </div>
                    <ul class="nav navbar-nav">
                        <li><a href= "calendario_signot" target="_blank"><i class="glyphicon glyphicon-calendar"></i> Ver Calendario</a></li>
                    </ul>
                ...
                <div class="jumbotron">
                    <div class="row">
                        ...
                        <div class="col-xs-6 col-md-8">
                            <h1 class="page-header">Gestión Agotada</h1>
                        </div>
                    </div>
                </div>     
             <?php }else{ ?> 
