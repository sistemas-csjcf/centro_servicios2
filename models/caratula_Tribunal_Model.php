...
class caratula_Tribunal_Model extends modelBase{
	...
	public function get_datos_proceso_x($identrada){
            ...
            if($identrada == 1){
                $sql = ("SELECT [A103LLAVPROC],[A103ANOTACTS],[A103FECHREPA]
                            ...
                            AND [A103CODIPONE] IN(3970,3971,3972,3973,3974,3975,3976,3977,3978)");		
                $params = array();
            ...
            if($identrada == 2){
                ...
                $sql = ("SELECT [A103LLAVPROC],[A103ANOTACTS],[A103FECHREPA]
                            FROM [ConsejoPN].[dbo].[T103DAINFOPROC]
                            WHERE [A103ANOTACTS] LIKE '%reparto%' AND [A103CODIPONE] IN(3970,3971,3972,3973,3974,3975,3976,3977,3978) " .$filtrox);
