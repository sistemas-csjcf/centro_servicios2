...
?>
    ...
    <div class="well well-sm text-right">
        <?php if($num_filas<1){ ?>
            <a class="btn btn-primary" href="?c=Hoja_vida&a=Crud&return_flag=2&band=1&us=<?php echo $id_user ?>"><span class="icon-user-plus"> </span> Registrar Datos Personales</a>
        <?php }else{ ?>
            <a class="btn btn-primary" href="?c=Hoja_vida&a=Crud&id=<?php echo $user; ?>&return_flag=2&band=0"><i class="fa fa-pencil"></i> Actualizar Datos Personales</a>
        <?php } ?>
    </div>
    <table id="example0" class="table table-striped dt-responsive nowrap" cellspacing="0" width="100%">
        <thead>
            <tr>
                <th>Cèdula</th>
                <th>Nombre</th>
...
<!--            <a class="btn btn-primary" href="?c=Hoja_vida&a=Crud_FormacionProfesional"><i class="fa fa-graduation-cap" aria-hidden="true"></i> Agregar Formación Profesional</a>-->
            <a href="javascript:void(0)" class="btn btn-primary" data-toggle="modal" data-target="#Modal_Estudios" data-id_us="<?php echo $user; ?>"data-id_hv="<?php echo $id_hv ?>"data-return_flag="2"data-usuario="<?php echo $id_user; ?>" ><i class="fa fa-graduation-cap" aria-hidden="true"></i> Agregar Formación Profesional</a>
        <?php } ?>    
    </div>
    ...
    <div class="well well-sm text-right">
        <?php if($num_filas>0){ ?>
            <a href="javascript:void(0)" class="btn btn-primary" data-toggle="modal" data-target="#Modal_Exp_Laboral" data-id_us="<?php echo $user; ?>"data-id_hv="<?php echo $id_hv ?>"data-return_flag="2"data-usuario="<?php echo $id_user; ?>" ><i class="fa fa-briefcase" aria-hidden="true"></i> Agregar Experiencia Laboral</a>
        <?php } ?>
    </div>
    <table id="example_historial_lab" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
        <thead>
            <tr>
                ...
                <th title="Editar Datos">Editar</th>
				<th title="Eliminar Datos">Eliminar</th>
            </tr>
        </thead>
        <tbody>
            <?php foreach($this->model->Listar_Exp_Laboral($id_hv) as $r): ?>
                <tr>
					...
					<td><a href="#" class="btn btn-danger" id="delete_expLab" data-toggle="modal" data-target="#Modal_ELIMINAR_Exp_Laboral" data-id="<?php echo $r->exp_id; ?>" data-id_us="<?php echo $user; ?>"data-id_hv="<?php echo $id_hv ?>"data-rama_flag="<?php echo $r->exp_rama_flag; ?>"data-cargo="<?php echo $r->exp_cargo; ?>"data-flag_cs="<?php echo $r->exp_CS_flag; ?>"data-return_flag="2"data-usuario="<?php echo $id_user; ?>" ><span class="glyphicon glyphicon-remove"></span></a></td>
                </tr>
            <?php endforeach; ?>
        </tbody>
    </table>
    ...
    <div class="well well-sm text-right">
        <?php //if($num_filas>0){ ?>
            <a href="javascript:void(0)" class="btn btn-primary" data-toggle="modal" data-target="#Modal_Ref_Personal" data-id_us="<?php echo $user; ?>"data-id_hv="<?php echo $id_hv ?>"data-return_flag="2"data-usuario="<?php echo $id_user; ?>" ><i class="fa fa-users"></i> Agregar Referencia Personal</a>
        <?php //} ?>
    </div>
    <table id="example4" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
        <thead>
            <tr>
                <th title="Còdigo Referencia Personal">ID</th>
                <th>Nombre</th>
                <th>Cargo</th>
                <th>Empresa</th>
                <th>Telèfono</th>
...
<!-- ///////////// Modal AGREGAR FORMACIÓN PROFESIONAL ////////////////////////////////////////////////////// -->
                ...
                <div class="modal-body">
                    <form role="form" action="?c=hoja_vida&a=Registrar_Estudios" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <input type="hidden" readonly="" class="form-control" name="id_user" id="id_user" placeholder="id USER Persona"/>
                            <input type="hidden" readonly="" class="form-control" name="usuario" id="usuario" placeholder="USER"/>
    ...
    <script>
        $('#Modal_Estudios').on('show.bs.modal', function (event) {
            ...
            modal.find('.modal-body input[name="usuario"]').val(usuario)
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">
                        Actualizar Formación Profesional<icon class="fa fa-briefcase"></icon>
                    </h4>
                </div>
                <!-- Modal Body -->
                <div class="modal-body">
                    <form role="form" action="?c=hoja_vida&a=Actualizar_Estudios" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            <input type="hidden" readonly="" name="id" id="id" placeholder="id estudio"/>
                            <input type="hidden" readonly="" name="id_hv" id="id_hv" placeholder="id Hoja Vida"/>
                            <input type="hidden" readonly="" name="usuario" id="usuario" placeholder="USER"/>
                            <input type="hidden" readonly="" name="id_user" id="id_user" placeholder="id USER"/>
                            <input type="hidden" readonly="" name="return_flag" id="return_flag" placeholder="Return Flag"/>
                        </div>
                        ...
                        <div class="form-group row">
                            <div class="col-xs-6">
                               ...
                               <input type="hidden" name="ruta_recu"  class="form-control" placeholder="ruta id Recu" />
                            </div>
                        </div>
                        <hr />
                        <div class="modal-footer">
...
<!-- ///////////// Modal EDITAR EXPERIENCIA LABORAL ////////////////////////////////////////////////////// -->
                    ...
                    <form role="form" action="?c=hoja_vida&a=Editar_Exp_laboral" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <div class="col-xs-6">
                               ...
                               <a id="ruta1" class="form-control" href="#" target="_blank" style="text-decoration:none;"><i class="icon-download3"></i>Descargar</a>
                            </div>
                        </div>
                        <hr />
                        <div class="modal-footer">
    ...
    <script>
        ...
        $('#Modal_EDITAR_Exp_Laboral').on('show.bs.modal', function (event) {
            ...
            modal.find(document.getElementById("ruta1").setAttribute("href",rutaFormato));
            modal.find('.modal-body input[name="ruta_recu"]').val(ruta);
            modal.find('.modal-body input[name="return_flag"]').val(flag_r)
        })
    </script>
...
<!-- ///////////// Modal ELIMINAR EXPERIENCIA LABORAL ////////////////////////////////////////////////////// -->
    <div class="modal fade" id="Modal_ELIMINAR_Exp_Laboral" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <!-- Modal Header -->
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">
                        ¿Seguro de Eliminar registro Experiencia Laboral?<icon class="fa fa-briefcase"></icon>
                    </h4>
                </div>
                <!-- Modal Body -->
                <div class="modal-body">
                    <form role="form" action="?c=hoja_vida&a=Eliminar_Exp_laboral" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            <input type="hidden" name="id" id="id"/>
                            <input type="hidden" name="id_hv" id="id_hv"/>
                            <input type="hidden" name="usuario" id="usuario"/>
                            <input type="hidden" name="return_flag" id="return_flag"/>
                        </div>
                        <div class="form-group">
                            <label for="cargo">Cargo</label>
                            <input type="text" class="form-control" id="exp_cargo" name="exp_cargo" placeholder="Cargo" required="">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
                            <button type="submit" class="btn btn-danger" id="subir"><span class="icon-floppy-disk"></span> Eliminar</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <script>
        $(document).ready(function(){
            $(document).on('click', '#delete_expLab', function(e){
                // Definimos las variables de javascrpt 
                var rama_flag  = $(this).data('rama_flag');
                var cs_flag    = $(this).data('flag_cs');
                var id_areaCS  = $(this).data('id_area_cs');
        ...
        $('#Modal_ELIMINAR_Exp_Laboral').on('show.bs.modal', function (event) {
            var button  = $(event.relatedTarget) 
            var id              = button.data('id')
            var id_us           = button.data('id_us')
            var id_hv           = button.data('id_hv')
