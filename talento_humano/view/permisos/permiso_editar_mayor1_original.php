...
//    // JUAN ESTEBAN MUNERA BETANCUR
    ...
    if(isset($id_user)){
?>
    <h1 class="page-header">Permiso mayor a 1 día...</h1>
    <ol class="breadcrumb">
        ...
        <table id="example" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
            <thead>
                <tr style="background-color: #4682B4; color: white;">
                    ...
                    <th>HORA INICIO</th>
                    <th>HORA FIN</th>
                    <th title="Código Usuario" style="width:12px;">TODO EL DÌA</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    ...
                    <td><input type="time" id="lunes"  class="form-control" name="m_lunes[]" onblur="clic1(this.value)"  disabled="" min="08:00" ></td>
                    <td><input type="time" id="lunes1" class="form-control" name="m_lunes[]" disabled="" max="18:00" ></td>
                    <td style="text-align: center"><input type="checkbox" id="check_LN1" onchange="check_Lunes_all()"></td>
                </tr>
                <tr>
                    <td style="text-align: center">
                    ...
                    <td style="text-align: center"><input type="checkbox" id="check_MT1" onchange="check_Martes_all()"></td>
                </tr>
                <tr>
                    <td style="text-align: center">
                    ...
                    <td><input type="time" id="miercoles"  class="form-control" name="m_miercoles[]" disabled="" min="08:00" ></td>
                    ...
                    <td style="text-align: center"><input type="checkbox" id="check_MI1" onchange="check_Miercoles_all()"></td>
                </tr>
                <tr>
                    <td style="text-align: center">
                    ...
                    <td style="text-align: center">
                        <input type="checkbox" id="check_JU1" onchange="check_Jueves_all()">
                ...
                <tr>
                    ...
                    <td style="text-align: center">
                        <input type="checkbox" id="check_VR1" onchange="check_Viernes_all()">
