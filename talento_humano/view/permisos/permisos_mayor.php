<?php 
    ...
    $datospermiso         = $modelo->get_lista_permisos_mayor();
...
?>
    ...
    <div class="form-group row">
        <div class="col-xs-3">
            <ol class="breadcrumb">
                <button class="btn btn-info" onclick="consultar_permisos_mayores()"><i class="fa fa-search" aria-hidden="true"></i> Consultar</button>
                ...
                <tr>
                    ...
                    <?php if (in_array($_SESSION['idUsuario'], $usuariosa) ) { ?> 
                        ...
                        <?php }else if($estado == "Aprobado"){ ?>
                            <td><?php echo $estado ?> <a href="app/libs/plantillero/crear_permiso_ordinario.php?per_mayor=1&id=<?php echo $r['id']; ?>" style="text-decoration: none;"><span class="icon-file-word" style="font-size: 25px;"> </span></a> 
                            </td>
                        <?php }else{ ?>
