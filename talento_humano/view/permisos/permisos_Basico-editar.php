<?php 
    ...
    if(isset($id_user)){
?>
    <h1 class="page-header">Permiso menor a un día.</h1>
    <ol class="breadcrumb">
        <?php if ( in_array($_SESSION['idUsuario'],$usuarioPr) ) { ?>
            <li><a href="?c=hoja_vida&a=Ver_lista_Permiso_Basico">Permisos</a></li>
        <?php } else { ?>
            <li><a href="?c=Hoja_vida&a=Ver_lista_Mis_Permiso_Basico" style="text-decoration: none"><span class="icon-clock"></span> Mis Permisos</a></li>
        <?php } ?>
