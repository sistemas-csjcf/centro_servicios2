...
?>
    <h1 class="page-header">Cantidad de Visitas por Trabajadora Social</h1>
        ...
        <div class="form-group">
            <button class="btn btn-info" onclick="consultar_estadisticaVisitasTS()"><i class="fa fa-search" aria-hidden="true"></i> Consultar</button>
