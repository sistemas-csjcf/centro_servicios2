<?php
    ...
    $templateWord = new TemplateProcessor('plantilla_nombramiento_provisionalidad.docx');
    //Variables -->
    $id    = $_REQUEST['id'];
    ...
    $sql = "SELECT `res_nom_id`, `res_nom_id_clase_nombra`, `res_nom_id_usuario`, `res_nom_fecha`, `res_nom_id_cargo`, `res_nom_consecutivo`, 
                ...
                us.nombre_usuario AS ced_empleado, car.car_titulo AS cargo
    ...
    $templateWord->setValue('fecha_larga_letras', $fecha_resolucion_letras );
