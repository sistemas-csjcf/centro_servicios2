<?php
    ...
    $templateWord = new TemplateProcessor('plantilla_nombramiento_propiedad.docx');
    //Variables -->
    $id    = $_REQUEST['id'];
    ...
    $sql = "SELECT `res_nom_id`, `res_nom_id_clase_nombra`, `res_nom_id_usuario`, `res_nom_fecha`, `res_nom_id_cargo`, `res_nom_consecutivo`, 
                ...
                us.nombre_usuario AS ced_empleado, us1.empleado AS reemplaza, us1.nombre_usuario AS ced_reemplaza , car.car_titulo AS cargo
            ...
            INNER JOIN pa_usuario AS us1 ON rn.`res_nom_id_user_reemplaza` = us1.id 
            WHERE res_nom_id = '$id'";
    ...
    while($row = mysql_fetch_array($res)){
        ...
        $ced_servidor2      = $row['ced_reemplaza'];
        $nom_servidor2      = $row['reemplaza'];
    ...
    $templateWord->setValue('cedula_reemplaza', $ced_servidor2 );
    $templateWord->setValue('nombre_reemplaza', $nom_servidor2 );
    $templateWord->setValue('fecha_larga_letras', $fecha_resolucion_larga );
    $templateWord->setValue('cargo', $cargo_servidor );
    $templateWord->setValue('descri_oficio', $oficio );
    $templateWord->setValue('descri_acuerdo', $acuerdo );
