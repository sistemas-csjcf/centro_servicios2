<?php
    ...
    $datos_juzgado = $modelo->get_codigo_Despacho($id_user);
    //get_codigo_Despacho
...
<!--                    <th>Días</th>-->
            ...
            <tbody>
                <?php foreach($this->model->alerta_tutelaD($cod_juzgado) as $r): ?>
                    <tr>
                        <td><?php echo $r->tut_id; ?></td>
                        <td><?php echo $r->tut_radicado; ?></td>
                        <td><?php echo $r->tut_clase; ?></td>
...
<!--                        <td><?php echo $r->tut; ?> <i class="glyphicon glyphicon-warning-sign gly-spin"></i></td>-->
                        <th><a href="#" class="btn btn-primary" title="Asignar Fecha Fallo de tutela" id="modal_Fallo" data-toggle="modal" data-target="#Modal_FalloTutela" data-id_tutela="<?php echo $r->tut_id; ?>" ><i class="fa fa-calendar"></i></a></th>
                    </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
