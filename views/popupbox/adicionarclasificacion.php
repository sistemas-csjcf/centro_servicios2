...
<form action="index.php?controller=signot&action=Adicionar_CP" method="post" name ="formcp" id="formcp" onsubmit="return validar_campos_cp();"> 
	...
	<table border="0" align="center">
		...
		<tr>
			<td align="center" colspan="2" style="width:180px; height:23px; border-color:#000000; font-size:16px ">ADICIONAR CLASIFICACION PARTE</td><br><br>
		</tr>
		<tr>
