...
function load(){
	var a = document.getElementsByName("ano")[0].value;
	var b = document.getElementsByName("consecutivo")[0].value;
	var c = document.getElementsByName("instancia")[0].value;
	var d = document.getElementsByName("juzgado")[0].value;
	var e = document.getElementsByName("radicado")[0].value;
	var f = document.getElementsByName("accionante")[0].value;
	if (a != "" && b != "" && c != "" && d != "" && e != "" && f != ""){
...
<!--Funci�n para crear las actuaciones-->
<script type="text/javascript">
numf=0;
...
if(m=='Tutela')
{
 actuaciones = new Array("Admisi�n","Archivo","Avoca Conocimiento","Confirmaci�n fallo","Confirmaci�n parcial","Desistimiento","Envio a la Corte Costitucional","Envio por competencia","Fallo 1� Instancia","Fallo 2� Instancia","Impugnaci�n","Inadmisi�n","Medida previa","Niega pruebas","Pruebas","Rechazo","vinculaci�n","Hecho superado","Correcci�n","Requerimiento", "Decisi�n", "No Concede", "Pone en Conocimiento", "Sentencia");
 ...
 ?>
          ...
          <tr>
            ...
            <td> <input type="checkbox" name="tiene_accionado" id="manual2" onchange="activar_acc(frm)" />
              ...
              <input type="button" name="btn_input_accionado" id="btn_input" disabled="disabled" value="Adicionar Accionado" class="non" onclick="crearFormAccionado(this,frm)" /></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
          ...
          <tr>
            ...
            <td><input type="checkbox" name="tiene_vinculado" id="manual3" onchange="activar_acc(frm)" />
              ...
              <input type="button" name="btn_input_vinculado" id="btn_input" disabled="disabled" value="Adicionar Vinculado" class="non" onclick="crearFormVinculado(this,frm)" /></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
          ...
          <tr>
            <td>&nbsp;</td>
            <td>
			<input type="button" name="btn_input" id="btn_input_accion" value="Adicionar Actuaci&oacute;n" class="non" onclick="crearForm(this,frm)" />			</td>
          </tr>
          <tr>
      ...
      $fecha=date('Y-m-d');?>
          ...
          <tr>
            ...
            <td style="position: relative;">
								<input type="submit" name="Submit" value="Registrar" id="btn_input" class="non" onclick="load()">
