...
if(m=='Tutela')
{
 actuaciones = new Array("Admisión","Archivo","Avoca Conocimiento","Confirmación fallo","Confirmación parcial","Desistimiento","Envio a la Corte Costitucional","Envio por competencia","Fallo 1° Instancia","Fallo 2° Instancia","Impugnación","Inadmisión","Medida previa","Niega pruebas","Pruebas","Rechazo","vinculación","Hecho superado","Corrección","Requerimiento", "Decisión", "No Concede", "Pone en Conocimiento", "Sentencia");
