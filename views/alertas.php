 ...
 <strong><?php echo $_SESSION['elemento']?></strong>.
  ...
  <!-- ------------------------------- Permiso Modulos ------------------------------- -->
 <div id="msg_elempermiso" style='display:none'>
 <br /><br /><span style="color:#CC0000; font-weight:bold; border-bottom: 1px solid #000000">Alerta:</span>
 <br /><br />
 <strong><?php echo $_SESSION['elemento']?></strong>.
 </div>
 
 <!-- ------------------------------- Error en carga del archivo ------------------------------- -->
 <div id="msg_errorarchivo" style='display:none'>
 <br /><br /><span style="color:#CC0000; font-weight:bold; border-bottom: 1px solid #000000">Alerta:</span>
 <br /><br />
 <strong><?php echo $_SESSION['elemento']?></strong>.
 </div>
...
<!-- ------------------------------- Permiso Modulos ------------------------------- -->
<?php if($_SESSION['elem_permiso'] == true){ ?>
<script type="text/javascript">
$('#msg_elempermiso').modal({onOpen: statusOpen,onClose: statusClose});
...
<?php 
	$_SESSION['elem_permiso'] = false; 
	unset($_SESSION['elem_permiso']);  
	unset($_SESSION['elemento']); 
} 
?>
<!-- ------------------------------- Error en carga del archivo ------------------------------- -->
<?php if($_SESSION['elem_error_archivo'] == true){ ?>
<script type="text/javascript">
$('#msg_errorarchivo').modal({onOpen: statusOpen,onClose: statusClose});
...
<?php 
	$_SESSION['elem_error_archivo'] = false; 
	unset($_SESSION['elem_error_archivo']);  
	unset($_SESSION['elemento']); 
} 
?>
