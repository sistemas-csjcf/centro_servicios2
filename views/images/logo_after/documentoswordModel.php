...
if($opcion == 1){
	...
	if($datos0c == 3){
		...
		while($conttabla < 9){
			...
			if($conttabla == 0){$campofila = /*$datos2.*/"SEÑOR(A): ";          $campofila2 = strtoupper($parte3);}
			if($conttabla == 1){$campofila = "DIRECCION: ";         $campofila2 = strtoupper($datos4);}
			if($conttabla == 2){$campofila = "CIUDAD: ";            $campofila2 = strtoupper($datos5);}
			if($conttabla == 3){$campofila = "JUZGADO DE ORIGEN: "; $campofila2 = strtoupper($dator3);}
			if($conttabla == 4){$campofila = "PROCESO: ";           $campofila2 = strtoupper($dator4);}
	...
	if($datos0c == 7){
		...
		while($conttabla < 9){
			...
			if($conttabla == 0){$campofila = "SEÑOR(A): ";          $campofila2 = strtoupper($parte3);}
			if($conttabla == 1){$campofila = "DIRECCION: ";         $campofila2 = strtoupper($datos4);}
			if($conttabla == 2){$campofila = "CIUDAD: ";            $campofila2 = strtoupper($datos5);}
			if($conttabla == 3){$campofila = "JUZGADO DE ORIGEN: "; $campofila2 = strtoupper($dator3);}
			if($conttabla == 4){$campofila = "PROCESO: ";           $campofila2 = strtoupper($dator4);}
	...
	if($datos0c == 47){
		...
		while($conttabla < 8){
			...
			if($conttabla == 0){$campofila = "SEÑOR(A): ";          $campofila2 = strtoupper($datos3);}
			if($conttabla == 1){$campofila = "DIRECCION: ";         $campofila2 = strtoupper($datos4);}
			if($conttabla == 2){$campofila = "CIUDAD: ";            $campofila2 = strtoupper($datos5);}
			if($conttabla == 3){$campofila = "JUZGADO DE ORIGEN: "; $campofila2 = strtoupper($dator3);}
			if($conttabla == 4){$campofila = "PROCESO: ";           $campofila2 = strtoupper($dator4);}
	...
	if($datos0c == 59){
		...
		$section->addText("NOTIFICACIÓN PERSONAL"."            "."RADICADO: ".$dator2, $fontStyleA, $paraStyleA2);
	...
	if($datos0c == 52){
		...
		$section->addText("Se le INFORMA que el término de traslado de la demanda es de ".$parte1." DIAS HABILES, CONTADOS A PARTIR DEL DÍA SIGUIENTE A LA PRESENTE NOTIFICACIÓN, la que se surte con la entrega de la copia de la demanda y los anexos. Se deja Constancia que al notificado (a) se le leyó el auto que admitió la demanda y se le hicieron las advertencias allí consignadas.",$fontStyleB, $paraStyleB2);
	...
	if($datos0c == 33){
		...
		$section->addText("Se le INFORMA que el término de traslado de la demanda es de ".$parte1." DIAS HABILES, CONTADOS A PARTIR DEL DÍA SIGUIENTE A LA PRESENTE NOTIFICACIÓN, la que se surte con la entrega de la copia de la demanda y los anexos.",$fontStyleB, $paraStyleB2);
	...
	if($datos0c == 34){
		...
		$section->addText("Se le INFORMA que el término de traslado de la demanda es de ".$parte2." DIAS HABILES, CONTADOS A PARTIR DEL DÍA SIGUIENTE A LA PRESENTE NOTIFICACIÓN, la que se surte con la entrega de la copia de la demanda y los anexos.",$fontStyleB, $paraStyleB2);
	...
	if($datos0c == 54){
		...
		$section->addText("Manizales, ".$fecha."; en la fecha comparece ante el CENTRO DE SERVICIOS JUDICIALES PARA LOS JUZGADOS CIVILES Y DE FAMILIA, ".strtoupper($parte3)." en calidad de apoderado de ".strtoupper($parte9).", con el fin de recibir NOTIFICACIÓN PERSONAL del auto que ".strtoupper($parte1)." dentro del proceso que seguidamente se menciona. ".$datos10,$fontStyleB, $paraStyleB2);
	...
	if($datos0c == 56){
		...
		$section->addText("DILIGENCIA DE NOTIFICACIÓN PERSONAL", $fontStyleA, $paraStyleA2);
		...
		while($conttabla < 9){
			...
			if($conttabla == 0){$campofila = "SEÑOR(RA): ";         $campofila2 = strtoupper($parte1);}
		...
		$section->addText("Se le comunica la providencia emitida por el juzgado antes citado, dentro del proceso de la referencia, para que si a bien lo tiene intervenga en el trámite de este proceso, dentro de los DIEZ (10) DÍAS siguientes al recibido de la presente comunicación, conforme a los artículos 610-612 del Código General del Proceso.",$fontStyleNO3, $paraStyleNO4);
			
		//$section->addTextBreak(1);
		
		$section->addText("Para tal efecto se le envía los siguientes documentos: ".$parte4,$fontStyleNO3, $paraStyleNO4);
		...
		while($conttabla < 6){
			...
			//if($conttabla == 5){$campofila = "";                     $campofila2 = "";}
			if($conttabla == 4){$campofila = "";                     $campofila2 = "Número de cédula";}
	...
	if($datos0c == 57){
		...
		$section->addText("Se le INFORMA que el término para aceptar o repudiar la herencia es de ".$parte1." DIAS HABILES, CONTADOS A PARTIR DEL DÍA SIGUIENTE A LA PRESENTE NOTIFICACIÓN, ( Artículos 591 del C.P.C y 1289 del C.C.).",$fontStyleB, $paraStyleB2);
	...
	if($datos0c == 70){
		...
		$section->addText("Manizales, ".$fecha."; en la fecha comparece ante el CENTRO DE SERVICIOS JUDICIALES PARA LOS JUZGADOS CIVILES Y DE FAMILIA, la persona que a continuación se identifica, con el fin de recibir NOTIFICACIÓN PERSONAL del auto como DILIGENCIA PREVIA, DONDE SE ORDENA NOTIFICARLE LA ".$datos6." QUE HACE EL SEÑOR (A) ".$parte1." A FAVOR DEL SEÑOR (A) ".$dator7.", dentro del proceso que seguidamente se menciona. ".$datos10,$fontStyleB, $paraStyleB2);
	...
	if($datos0c == 71){
		...
		$section->addText("Manizales, ".$fecha."; en la fecha el señor (a) ".strtoupper($parte1)." con c.c. ".$parte2.", adscrito a la planta de personal del CENTRO DE SERVICIOS JUDICIALES PARA LOS JUZGADOS CIVILES Y DE FAMILIA, debidamente autorizado por el Coordinador (a) ".strtoupper($datoofi6)." y a solicitud del ".strtoupper($dator3)." de Manizales, se traslada a ".strtoupper($parte3)." para notificar personalmente al señor (a) ".strtoupper($dator5).", el auto que señala fecha y hora para la diligencia de interrogatorio de parte dentro de las diligencias que seguidamente se relaciona. ".$datos10,$fontStyleB, $paraStyleB2);
		...
		while($conttabla < 8){
			...
			if($conttabla == 6){$campofila = "FECHA AUTO: ";              $campofila2 = strtoupper($fa." ".$datos10);}
			if($conttabla == 7){$campofila = "ANEXOS: ";                  $campofila2 = strtoupper("COPIA DEL AUTO QUE SEÑALA FECHA Y HORA PARA LA DILIGENCIA DE INTERROGATORIO DE PARTE. ".$parte4);}
		...
		$section->addText("AL CITADO SE LE ADVIERTE que debe comparecer a ese Despacho Judicial el día ".$parte5.". con su documento de identidad, La no asistencia se le dará aplicación al artículo 210 del C. de P. Civil.",$fontStyleB, $paraStyleB2);
	...
	if($datos0c == 72){
		...
		$section->addText("SE LE NOTIFICA LA EXISTENCIA DE LOS TITULOS EJECUTIVOS PRESENTADOS CON LA DEMANDA COMO HEREDERO DETERMINADO DE EL SEÑOR (A): ".$parte1." ASI MISMO SE LE HACE SABER LA EXISTENCIA DE LA OBLIGACION. LO ANTERIOR DE CONFORMIDAD CON EL ARTICULO. 1434 DEL CODIGO CIVL.",$fontStyleB, $paraStyleB2);
	...
	if($datos0c == 73){
		...
		$section->addText("Se le advierte que debe comparecer a ese Despacho Judicial el día ".$parte1." con su documento de identidad. La no asistencia a la diligencia se tendrá por surtido el reconocimiento. (art. 274 de C.P.C.)",$fontStyleB, $paraStyleB2);
	...
	if($datos0c == 60){
		...
		while($conttabla < 8){
			...
			if($conttabla == 0){$campofila = "SEÑOR(A): ";          $campofila2 = strtoupper($parte2);}
			if($conttabla == 1){$campofila = "DIRECCION: ";         $campofila2 = strtoupper($datos4);}
			if($conttabla == 2){$campofila = "CIUDAD: ";            $campofila2 = strtoupper($datos5);}
			if($conttabla == 3){$campofila = "JUZGADO DE ORIGEN: "; $campofila2 = strtoupper($dator3);}
			if($conttabla == 4){$campofila = "PROCESO: ";           $campofila2 = strtoupper($dator4);}
		...
		$section->addText("ADVERTENCIA: SE LE ADVIERTE QUE LA NOTIFICACIÓN SE CONSIDERARÁ SURTIDA AL FINALIZAR EL DÍA SIGUIENTE AL DEL RECIBO DEL PRESENTE AVISO.",$fontStyleNO3, $paraStyleNO4);
			
		//$section->addTextBreak(1);
		
		$section->addText("RETIRO DE COPIAS: DISPONE DEL TÉRMINO DE TRES (3) DÍAS PARA RETIRAR DEL CENTRO DE SERVICIOS JUDICIALES DE LOS JUZGADOS CIVILES Y DE FAMILIA, UBICADO EN LA DIRECCIÓN QUE APARECE AL PIE DE ESTA PAGINA, LAS COPIAS DE LOS ANEXOS DE LA DEMANDA, VENCIDOS LOS ANTERIORES, COMENZARÁ A CORRERLE EL TÉRMINO DEL TRASLADO DE LA MISMA.",$fontStyleNO3, $paraStyleNO4);
		...
		$section->addText("DE CONFORMIDAD CON EL ART. 292 DEL CÓDIGO GENERAL DEL PROCESO, SE LE NOTIFICA LA PROVIDENCIA FECHADA DEL ".strtoupper($fechaauto).", POR MEDIO DEL CUAL SE ".$datos6." EN SU CONTRA DENTRO DEL PROCESO ANTES REFERENCIADO. ".$datos10,$fontStyleNO3, $paraStyleNO4);
		...
		$section->addText("LA COPIA DEL ESCRITO DE LA DEMANDA CON LOS ANEXOS QUEDAN A DISPOSICIÓN DE LA PARTE INTERESADA PARA SER RETIRADOS.",$fontStyleNO3, $paraStyleNO4);
	...
	if($datos0c == 36){
		...
		$section->addText("DEVOLUCIÓN DOCUMENTOS GESTION AGOTADA", $fontStyleA, $paraStyleA2);
		...
		$section->addText("MOTIVO DE LA DEVOLUCIÓN ",$fontStyleI, $paraStyleI2);
	...
	if($datos0c == 37){
		...
		$section->addText("DEVOLUCIÓN DOCUMENTOS A SOLICITUD DEL JUZGADO", $fontStyleA, $paraStyleA2);
	...
	if($datos0c == 38){
		...
		$section->addText("DEVOLUCIÓN DOCUMENTOS NOTIFICACION PERSONAL", $fontStyleA, $paraStyleA2);
		...
		$section->addText("SE DEVUELVEN LAS DILIGENCIAS AL JUZGADO POR CUANTO EL O LOS DEMANDADO(S) SE NOTIFICÓ (ARON) PERSONALMENTE EN EL CSJCF EL ".strtoupper($fecha2),$fontStyleG, $paraStyleG2);
	...
	if($datos0c == 39){
		...
		$section->addText("DEVOLUCIÓN DOCUMENTOS NOTIFICACION POR AVISO", $fontStyleA, $paraStyleA2);
	...
	if($datos0c == 40){
		...
		$section->addText("DEVOLUCIÓN DOCUMENTOS DEVOLUCION CORREO", $fontStyleA, $paraStyleA2);
	...
	/*if($datos0c == 68){
		...
		$section->addText("El demandado exhibe la notificación por aviso y manifiesta haberla recibido el día de hoy, ".$fechaauto,$fontStyleG, $paraStyleG2);
	...
	if($datos0c == 68){
		...
		$section->addText("Manizales, ".$fecha.",  presente ante este Centro de Servicios el Señor (a) ".$dator5." identificado con C.C. ".$dator6.", en calidad de demandado  dentro del proceso ".$dator4.", promovido por el Señor (a) ".$parte1.", que se tramita en el ".$dator3." de esta Ciudad.",$fontStyleB, $paraStyleB2);
		
		$section->addTextBreak(1);
		
		$section->addText("El demandado exhibe la notificación por aviso y manifiesta haberla recibido el día de hoy, ".$fechaauto,$fontStyleB, $paraStyleB2);
	...
	if($datos0c == 69){
		...
		$section->addText("Manizales, ".$fecha.", presente ante este Centro de Servicios el Dr (a). ".$parte1." identificado con C.C. No. ".$parte2." y T.P. No. ".$parte3." en calidad de apoderado de la Señor (a) ".$dator5." CITADA dentro del proceso  ".$dator4.", promovido por el Señor (a) ".$parte4.", que se tramita en el ".$dator3." de esta Ciudad.",$fontStyleB, $paraStyleB2);
		
		$section->addTextBreak(1);
		
		$section->addText("El apoderado manifiesta haber recibido la notificación por aviso y manifiesta haberla recibido el día de hoy, ".$fechaauto,$fontStyleB, $paraStyleB2);
	...
	if($idcaratulaplantilla == 400){
		...
		while($conttabla < 11){
			...
			if($conttabla == 3){$campofila = "IDENTIFICACIÒN: ";       $campofila2 =$datosdemandantec;}
			...
			if($conttabla == 7){$campofila = "NIT/IDENTIFICACIÒN: ";   $campofila2 =$datosdemandadoc;}
