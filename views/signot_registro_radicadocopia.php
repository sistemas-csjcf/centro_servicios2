...
<html lang="es">
    <head>
        ...
        <script src="assets/js/funciones_jest.js" type="text/javascript" charset="utf-8"></script>
                    ...
                    <div id="contenido">		
                        <form id="frm" name="frm" method="post" enctype="multipart/form-data" action="">
                            ...
                            <table border="0" cellspacing="0" cellpadding="0" id="frm_editar">
                                <tr>
                                    <td><label style="width:151px; color:#666666">Año:</label></td>
                                    <td>				
                                ...
                                <tr>
                                    <td><label style="width:151px; color:#666666">Instancia:</label></td>
                                    <td>
                                        <label>
                                ...
                                <tr>
                                    <td><label style="width:151px; color:#666666">Clase Proceso:</label></td>
                                    <td>									
                                ...
                                <tr>
                                    <td ><a href="#" onclick="migrarPartes()"><span style="font-size: 40px" class="icon-cloud-download"></span>Migrar Partes Justicia</a></td>
                                    <td >
                                 ...
                                 <tr><td colspan="2"><div id="listar_partesJusticia"></div></td></tr>
                                <tr id="filapartes">		
                                    <td colspan="2">
                                        <table border="5" cellspacing="0" cellpadding="0" rules="rows" id="frm_partes">
                                            ...
                                            <tr>
                                                <td><label style="width:151px; color:#666666">Cedula:</label></td>
                                                <td>
                                                    <input name="idpartey" id="idpartey" type="text" readonly="true"/>
                                                    <input type="text" name="cedulareg" id="cedulareg" maxlength="25" onKeyUp="Traer_Datos_Partes_Reg(this.value)"/>
                                                </td>
                                                <td><label style="width:151px; color:#666666">Nombre:</label></td>
                                                <td><input type="text" name="nombrereg" id="nombrereg" maxlength="2000"/></td>
                                            </tr>
                                            <tr>
                                                <td><label style="width:151px; color:#666666">Clasificacion Parte:</label></td>
                                                <td>
                                                ...
                                                <td><label style="width:151px; color:#666666">Datos Adicionales:</label></td>
                                                <td><input type="text" name="datosadicionalesreg" id="datosadicionalesreg" /></td>								
                                            </tr>
                                            <tr>
                                                ...
                                                <td>											
                                                    <select name="departamento" id="departamento" onChange="Obtener_Municipio()">
                                                        ...
                                                        <?php  while($row = mysql_fetch_array($res)){ ?> 
                                                            <option value="<?php echo $row['Cod_departamento'] ?>"><?php echo $row['descripcion']; ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </td>
