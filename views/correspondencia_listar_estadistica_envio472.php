    ...
    <body>
        ...
        <table border="0" cellspacing="0" cellpadding="0" align="center">
            ...
            <tr>
                <td>
                    <div id="contenido">
                        <div id="titulo_frm">Listar Cantidad Envios 4-72</div>
                        <table border="0" cellspacing="0" cellpadding="0" id="frm_editar">
                            ...
                            <tr>
                                <td>&nbsp;</td>
                                <td><a id="btn_input" onclick="listar_total_envios472()">Consultar </a></td>
                                <td><input type="reset" name="Submit2" value="Restablecer" id="btn_input" class="btn_limpiar" onclick="window.location.reload()" /></td>
                                <td>&nbsp;</td>
                            </tr>
                        </table><br/>		
                        <div id="load" style="display: none"></div>
                        <div class="filtro" id="listado_total_envios"></div>   
                    </div>		
		</td>
            </tr>
            <tr><td>&nbsp;</td></tr>
