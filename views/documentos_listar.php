...
<!-- SE DEFINEN LAS LIBRERIAS DE ESTA FORMA PARA EVITAR CONFLICTOS COMO EL DESPLIEGUE DE MENUS, QUE AL REALIZAR UN REGISTRO SALGA EL MENSAJE DE CONFIRMACION, SEGUIDO DE LAS LIBRERIAS FUNCIONES JAVASCRIPT COMO mainmenu() Y $(document).ready(function() , YA QUE SI SE DEFINEN MAS ARRIBA AL NO ENCONTRAR LAS LIBRERIAS TAMBIEN PUEDE PRESENTAR INCONSISTENCIAS. PARA EL MANEJO DE LAS FECHAS, SI SE USA DIRECTAMENTE POR EJEMPLO EN ESTE FORMULARIO SE DEFINE ALGO COMO
...
<body>
	...
	<table border="0" cellspacing="0" cellpadding="0" align="center">
		<tr>
		 ...
		 <tr>
    		<td>
				<!-- NOTA: LOS ID DE LOS CAMPOS ME DAN LOS ESTILOS, UBICADOS EN centro_servicios\views\css\main.css TENIENDO EN CUENTA EL ID DE LA TABLA DONDE SE ENCUENTRAN LOS CAMPOS EN ESTE CASO frm_editar LA class="required" ME PERMITE VALIDAR UN CAMPO CON JQUERY-->
				<!-- <div id="contenido"> -->
					<form id="frm" name="frm" method="post" enctype="multipart/form-data" action="">
						...
						<table border="0" cellspacing="0" cellpadding="0" id="frm_editar">
							<tr>
								...
								<td colspan="4">
									<input type="text" name="radicadox" id="radicadox" value="<?php echo trim($_GET['datox10']); ?>">
								</td>
							</tr>
							<tr>
								<td>
									...
									<select name="usuariox" id="usuariox">
										...
										<?php
											while($row = $datosuser2->fetch()){
												//PREGUNTO QUE OPCION SE ENVIO PARA SER SELECCIONADA DE LA VISTA sigdoc_listar_documentos_salientes.php AL DAR CLIC EN CONSULTAR
												if($row[id] == trim($_GET['datox11'])){
													echo "<option value=\"". $row[id] ."\" selected='selected'>" . $row[empleado] . "</option>";
												}
												else{
	...
	<?php
	//PREGUNTO SI SE A ENVIADO ALGUN FILTRO PARA QUE LA TABLA SEA VISIBLE. if(!empty($opcion)){ 
	?>
					...
					<tbody>		
						<?php while($row = $datosdocumentossalientes->fetch()){ ?>
							<tr>
								...
								<!-- wordwrap me permite cortar las lineas del texto cuando cuente 20 caracteres y baja el siguiente a otra linea esto con el objeto que se refleje todo el texto en la tabla html y no se alargue dicha tabla-->
