...
<table border="0" cellspacing="0" cellpadding="0" align="center">
 ...
 ?>
             ...
             <tr>
               <td>Mes Archivar:</td>
               <td colspan="2"><label>
                 <select name="mes[]" size="12" multiple="multiple" id="sl_input">
            ...
            <td colspan="2"><label>
             ...
             <tr>
               ...
               <td width="307" colspan="-1"><input name="desde_caja" type="text" class="number" id="txt_input2"  /></td>
             </tr>
             <tr>
               <td>Hasta:</td>
               <td colspan="-1"><input type="text" name="hasta_caja" id="txt_input7" class="number" /></td>
             </tr>
             <tr>
               <td>Cantidad Cajas</td>
               <td colspan="-1"><input type="procesos" name="cantidad_cajas" id="txt_input8" class="number" /></td>
             </tr>
              <tr>
               <td rowspan="7">Consecutivo de Expedientes</td>
               <td>Desde:</td>
               <td colspan="-1"><input type="text" name="desde_expediente" id="txt_input9" class="number" /></td>
             </tr>
             <tr>
               <td>Hasta:</td>
               <td colspan="-1"><input type="text" name="hasta_expediente" id="txt_input10" class="number" /></td>
             </tr>
             <tr>
               <td>Cantidad Expedientes:</td>
               <td colspan="-1"><input type="procesos" name="cantidad_expedientes" id="txt_input11" class="number" /></td>
             </tr>
             <tr>
