...
?>
    <h1 class="page-header">Cantidad de Encuestas por Calificación</h1>
        ...
        <div class="form-group">
            <button class="btn btn-info" onclick="consultar_estadisticaCantidadEncuestasCalif()"><i class="fa fa-search" aria-hidden="true"></i> Consultar</button>
