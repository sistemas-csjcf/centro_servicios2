    ...
    <table id="example_historial" class="table table-striped table-bordered table-hover dt-responsive nowrap" cellspacing="0" width="100%">
        <thead>
            <tr style="background-color: #4682B4; color: white;">
                ...
                <th title="Código Visita" style="width:12px">ID Inf.</th>
                <th style="width:12px">Fecha Visita</th>
				<th title="Fecha Recepción Informe" style="width:12px">Fecha Recepción</th>
                <th>Radicado</th>
        ...
        <tbody>        
            <?php foreach($this->model->Listar_Historial_valoracion_visitaDespacho() as $r): ?>
                <tr>
                    ...
                    <td><a href="#" data-toggle="modal" data-target="#myModalNorm" data-id="<?php echo $r->vis_pro_id ?>"data-id2="<?php echo $r->inf_val_id ?>"data-asistente="<?php echo $r->vis_TSoci_nombre ?>"data-fecha1="<?php echo $r->inf_val_fechaRecepcion ?>"data-fecha2="<?php echo $r->inf_val_fechaPresentacion ?>" data-solicitante="<?php echo $r->vis_pro_solicitante ?>"data-radicado="<?php echo $r->vis_pro_radicado ?>"data-observaciones="<?php echo $r->inf_val_observaciones ?>"data-subclase="<?php echo $r->vis_pro_subclase_proceso ?>"data-resp1="<?php echo $r->inf_val_cumpleObjetivo ?>"data-obj1="<?php echo $r->inf_val_cumpleObjetivoRespuesta ?>"data-oportunamente="<?php echo $r->inf_val_oportunamente ?>"data-res_oportuna2="<?php echo $r->inf_val_oportunamenteRespuesta ?>"data-val_despacho="<?php echo $r->inf_val_valoracionDespacho ?>"data-name_valora1="<?php echo $r->inf_val_nombreValoracion ?>"data-inf_enviado="<?php echo $r->inf_val_enviado ?>" ><i class="fa fa-eye fa-2x"></i></a></td>
                </tr>
            <?php endforeach; ?>
        </tbody>
    </table> 
