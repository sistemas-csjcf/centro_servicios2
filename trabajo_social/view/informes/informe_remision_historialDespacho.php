<?php 
    ...
    if(isset($id_user)){
?>
        <h1 class="page-header">Historial Remisión Informe</h1>
        <table id="example_historial" class="table table-striped table-bordered table-hover dt-responsive nowrap" cellspacing="0" width="100%">
            <thead>
                <tr style="background-color: #4682B4; color: white;">
                    ...
                    <th title="Informe Impreso">Informe Impreso</th>
                </tr>
            </thead>
            <tbody>        
                <?php foreach($this->model->Listar_Historial_Informe_RemisionDespacho() as $r): ?>
                    <tr>
                        ...
                        <td><a href="#" data-toggle="modal" data-target="#myModalNorm" data-id="<?php echo $r->vis_pro_id ?>"data-idseguimiento="<?php echo $r->vis_inf_id ?>"data-id1="<?php echo $r->inf_rem_id ?>"data-asistente="<?php echo $r->vis_TSoci_nombre ?>"data-fecha1="<?php echo $r->inf_rem_fecha_presentacion ?>"data-fecha2="<?php echo $r->inf_rem_fecha_remision ?>" data-solicitante="<?php echo $r->vis_pro_solicitante ?>"data-radicado="<?php echo $r->vis_pro_radicado ?>"data-observaciones="<?php echo $r->inf_rem_observaciones ?>"data-subclase="<?php echo $r->vis_pro_subclase_proceso ?>"data-numpers="<?php echo $r->vis_inf_num_personas ?>"data-diferencia="<?php echo $r->inf_rem_num_dif_dias ?>"data-user="<?php echo $r->vis_inf_id_usuario ?>"data-ruta="<?php echo $r->vis_inf_ruta_formato ?>"data-num_oficio="<?php echo $r->inf_rem_num_oficio ?>"data-num_folios="<?php echo $r->inf_rem_num_folios ?>" ><i class="fa fa-eye fa-2x"></i></a></td>
                        <td>
                            <?php if($r->inf_rem_impreso ==0){ ?>
                                <a onclick="javascript:return confirm('¿Seguro informe Impreso?');" href="?c=Visitas&a=Impreso&data-id=<?php echo $r->inf_rem_id; ?>&data-us=<?php echo $id_user; ?>" title="Informe Impreso">
